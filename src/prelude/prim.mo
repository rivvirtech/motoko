...
module Types = {
  ...
  public type Nat128 = prim "Nat128";
  public type Nat256 = prim "Nat256";
...
let nat128ToNat = @nat128ToNat;
let nat256ToNat = @nat256ToNat;
let natToNat128 = @natToNat128;
let natToNat256 = @natToNat256;
...
func nat8ToNat128(n : Nat8) : Nat128 = (prim "num_conv_Nat8_Nat128" : Nat8 -> Nat128) n;
func nat16ToNat128(n : Nat16) : Nat128 = (prim "num_conv_Nat16_Nat128" : Nat16 -> Nat128) n;
func nat32ToNat128(n : Nat32) : Nat128 = (prim "num_conv_Nat32_Nat128" : Nat32 -> Nat128) n;
func nat64ToNat128(n : Nat64) : Nat128 = (prim "num_conv_Nat64_Nat128" : Nat64 -> Nat128) n;
func nat8ToNat256(n : Nat8) : Nat256 = (prim "num_conv_Nat8_Nat256" : Nat8 -> Nat256) n;
func nat16ToNat256(n : Nat16) : Nat256 = (prim "num_conv_Nat16_Nat256" : Nat16 -> Nat256) n;
func nat32ToNat256(n : Nat32) : Nat256 = (prim "num_conv_Nat32_Nat256" : Nat32 -> Nat256) n;
func nat64ToNat256(n : Nat64) : Nat256 = (prim "num_conv_Nat64_Nat256" : Nat64 -> Nat256) n;
func nat128ToNat256(n : Nat128) : Nat256 = (prim "num_conv_Nat128_Nat256" : Nat128 -> Nat256) n;
func nat128ToNat8(n : Nat128) : Nat8 = (prim "num_conv_Nat128_Nat8" : Nat128 -> Nat8) n;
func nat128ToNat16(n : Nat128) : Nat16 = (prim "num_conv_Nat128_Nat16" : Nat128 -> Nat16) n;
func nat128ToNat32(n : Nat128) : Nat32 = (prim "num_conv_Nat128_Nat32" : Nat128 -> Nat32) n;
func nat128ToNat64(n : Nat128) : Nat64 = (prim "num_conv_Nat128_Nat64" : Nat128 -> Nat64) n;
func nat256ToNat8(n : Nat256) : Nat8 = (prim "num_conv_Nat256_Nat8" : Nat256 -> Nat8) n;
func nat256ToNat16(n : Nat256) : Nat16 = (prim "num_conv_Nat256_Nat16" : Nat256 -> Nat16) n;
func nat256ToNat32(n : Nat256) : Nat32 = (prim "num_conv_Nat256_Nat32" : Nat256 -> Nat32) n;
func nat256ToNat64(n : Nat256) : Nat64 = (prim "num_conv_Nat256_Nat64" : Nat256 -> Nat64) n;
func nat256ToNat128(n : Nat256) : Nat128 = (prim "num_conv_Nat256_Nat128" : Nat256 -> Nat128) n;
...
func popcntNat128(w : Nat128) : Nat128 = (prim "popcnt128" : Nat128 -> Nat128) w;
func clzNat128(w : Nat128) : Nat128 = (prim "clz128" : Nat128 -> Nat128) w;
func ctzNat128(w : Nat128) : Nat128 = (prim "ctz128" : Nat128 -> Nat128) w;
func popcntNat256(w : Nat256) : Nat256 = (prim "popcnt256" : Nat256 -> Nat256) w;
func clzNat256(w : Nat256) : Nat256 = (prim "clz256" : Nat256 -> Nat256) w;
func ctzNat256(w : Nat256) : Nat256 = (prim "ctz256" : Nat256 -> Nat256) w;
